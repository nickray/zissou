...
#[doc = r" Proxy"]
pub struct _GPIOISMENW<'a> {
    w: &'a mut W,
}
impl<'a> _GPIOISMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _HASH1SMENW<'a> {
    w: &'a mut W,
}
impl<'a> _HASH1SMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 8 - IO port I clocks enable during Sleep and Stop modes"]
    #[inline]
    pub fn gpioismen(&mut self) -> _GPIOISMENW {
        _GPIOISMENW { w: self }
    }
    #[doc = "Bit 14 - DCMI clock enable during Sleep and Stop modes"]
    #[inline]
    pub fn dcmismen(&mut self) -> _DCMISMENW {
        _DCMISMENW { w: self }
    }
    #[doc = "Bit 17 - HASH clock enable during Sleep and Stop modes"]
    #[inline]
    pub fn hash1smen(&mut self) -> _HASH1SMENW {
        _HASH1SMENW { w: self }
    }
}
