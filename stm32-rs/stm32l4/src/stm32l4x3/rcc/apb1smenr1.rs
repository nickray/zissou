...
#[doc = r" Proxy"]
pub struct _RTCAPBSMENW<'a> {
    w: &'a mut W,
}
impl<'a> _RTCAPBSMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _USBFSSMENW<'a> {
    w: &'a mut W,
}
impl<'a> _USBFSSMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn usbfssmen(&self) -> USBFSSMENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 26;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 10 - RTC APB clock enable during Sleep and Stop modes"]
    #[inline]
    pub fn rtcapbsmen(&mut self) -> _RTCAPBSMENW {
        _RTCAPBSMENW { w: self }
    }
    #[doc = "Bit 26 - USB FS clock enable during Sleep and Stop modes"]
    #[inline]
    pub fn usbfssmen(&mut self) -> _USBFSSMENW {
        _USBFSSMENW { w: self }
    }
}
