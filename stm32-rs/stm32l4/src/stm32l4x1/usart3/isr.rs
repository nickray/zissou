...
#[doc = "Possible values of the field `TCBGT`"]
...
impl TCBGTR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            TCBGTR::NOTCOMPLETED => false,
            TCBGTR::COMPLETED => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> TCBGTR {
        match value {
            false => TCBGTR::NOTCOMPLETED,
            true => TCBGTR::COMPLETED,
        }
    }
    #[doc = "Checks if the value of the field is `NOTCOMPLETED`"]
    #[inline]
    pub fn is_not_completed(&self) -> bool {
        *self == TCBGTR::NOTCOMPLETED
    }
    #[doc = "Checks if the value of the field is `COMPLETED`"]
    #[inline]
    pub fn is_completed(&self) -> bool {
        *self == TCBGTR::COMPLETED
    }
}
impl R {
